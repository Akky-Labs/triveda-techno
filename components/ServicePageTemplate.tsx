                ...
                <main className="pt-20">
                    ...
                    <section className="relative px-4 py-24 md:py-32 overflow-hidden bg-transparent">
                        <div className="max-w-7xl mx-auto">
                            ...
                            <h1 className="text-3xl md:text-6xl lg:text-7xl font-black font-heading tracking-tighter leading-[1.1] mb-8 md:mb-12 max-w-5xl">
                    ...
                    <section className="px-4 py-24 md:py-36 bg-card/30 relative border-y border-border">
                        <div className="max-w-7xl mx-auto">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-start">
                                {/* Left Side: Deliverables */}
                                <div>
                                    <h2 className="text-3xl md:text-5xl font-bold font-heading mb-12 tracking-tight">
                                        What We Do
                                    </h2>
                                    <div className="grid grid-cols-1 gap-4">
                                        {whatWeDo.map((item, i) => (
                                            <motion.div 
                                                ...
                                                className="flex items-center gap-4 p-5 rounded-2xl bg-background border border-border group hover:border-indigo-500/30 transition-all shadow-sm"
                                            >
                                                <div className="h-2 w-2 rounded-full bg-indigo-500 shrink-0 group-hover:scale-150 transition-transform" />
                                                <span className="text-base md:text-lg font-semibold text-foreground/90">{item}</span>
                                            </motion.div>
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="space-y-12">
                                    <h2 className="text-3xl md:text-5xl font-bold font-heading mb-12 tracking-tight text-indigo-500">
                                        Business Impact
                                    </h2>
                                    <div className="space-y-6">
                                        {businessImpact.map((impact, i) => (
                                            <motion.div 
                                                ...
                                                className="flex gap-5 p-8 rounded-[2.5rem] bg-indigo-500/5 border border-indigo-500/10 group hover:bg-indigo-500/10 transition-all shadow-md"
                                            >
                                                <CheckCircle2 size={24} className="text-indigo-500 shrink-0 mt-1" />
                                                <p className="text-lg md:text-xl font-bold leading-tight group-hover:text-foreground transition-colors">
                                                    {impact}
                                                </p>
                                            </motion.div>
                                        ))}
                    ...
                    <section className="px-4 py-24 md:py-32 text-center bg-background">
                        <div className="max-w-4xl mx-auto">
                            <ScaleOnScroll>
                                <div className="p-10 md:p-20 rounded-[3rem] md:rounded-[4rem] bg-linear-to-br from-indigo-600/10 via-card to-blue-600/5 border border-indigo-500/20 backdrop-blur-3xl relative overflow-hidden group shadow-2xl">
